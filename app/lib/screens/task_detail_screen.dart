...
class _TaskDetailScreenState extends State<TaskDetailScreen> {
  ...
  void initState() {
    super.initState();
    // 保存直後で提案が未生成なら自動生成（仕様 §2.2: 保存と同時に自動生成）
    final t = task;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: _delete,
            child: const Text('削除', style: TextStyle(color: AdhtColors.red)),
          ),
        ],
      ),
      body: ListView(
          ...
          child: const Column(
            children: [
              ...
              Text('AIが最初の一歩を考えています…',
                  style:
                      TextStyle(fontSize: 13.5, color: AdhtColors.muted)),
            ],
          ),
        ),
      ];
          ...
          child: Column(
            ...
            children: [
              ...
              FilledButton(
                ...
                onPressed: () =>
                    store.updateTask(t, (x) => x.firstStep = null),
        ...
        child: Column(
          children: [
            for (final (i, s) in t.suggestions.take(3).indexed) ...[
              ...
              InkWell(
                onTap: () => store.updateTask(t, (x) => x.firstStep = s),
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const AdhtBadge('これ', background: AdhtColors.accent),
                    ],
                  ),
                ),
              ),
